...
| `build_dir/.../arm-trusted-firmware-mediatek-mt7981-ram-ddr3/.../bl2.bin` | NR3053 & VHT-32X6 — BL2 RAM payload (Lấy từ kết quả build) |
| `bin/targets/mediatek/filogic/immortalwrt-mediatek-filogic-viettel_nr3053-bl31-uboot.fip` | NR3053 FIP (Lấy từ kết quả build) |
| `bin/targets/mediatek/filogic/immortalwrt-mediatek-filogic-vht_32x6-bl31-uboot.fip` | 32X6 FIP (Lấy từ kết quả build) |
...
sudo ../mtk_uart/mtk_uartboot --serial /dev/ttyUSB0 \
  --payload build_dir/target-aarch64_cortex-a53_musl/arm-trusted-firmware-mediatek-mt7981-ram-ddr3/arm-trusted-firmware-mediatek-*/build/mt7981/release/bl2.bin \
  --fip bin/targets/mediatek/filogic/immortalwrt-mediatek-filogic-vht_32x6-bl31-uboot.fip \
  --aarch64
```

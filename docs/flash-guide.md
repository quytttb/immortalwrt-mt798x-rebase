# Hướng dẫn nạp firmware ImmortalWrt V2
...
- [Viettel VHT-32X6V1](#viettel-vht-32x6v1)
  - [Walkthrough đầy đủ (Factory, GPIO, gỡ lỗi)](WALKTHROUGH_VHT_32X6.md)
...
| LAN sau boot (Linux) | `192.168.1.1` (VHT-32X6) / `192.168.10.1` (NR3053) |
...
### Bộ công cụ UART — `IMMORTALWRT/mtk_uart/`
...
> **Đang chạy ROM Keenetic?** Bảng phân vùng khác ImmortalWrt — lỗi UBI sau `mtk_uartboot` là bình thường. Xem [KEENETIC_TO_IMMORTALWRT_32X6.md](KEENETIC_TO_IMMORTALWRT_32X6.md).

> **Walkthrough chi tiết** (Factory, GPIO đã verify, gỡ lỗi): [WALKTHROUGH_VHT_32X6.md](WALKTHROUGH_VHT_32X6.md)  
> **GPIO LED thực tế:** Power/WPS GPIO 5, Internet GPIO **9** (không phải 8), WiFi 2.4G/5G GPIO 34/35. Không có cổng USB (giống NR3053). Patch cộng đồng GPIO 7/8 không khớp phần cứng này.
...
*Firmware build: `IMMORTALWRT/immortalwrt-mt798x-rebase/bin/targets/mediatek/filogic/`*  
*UART toolkit: `IMMORTALWRT/mtk_uart/`*  

...
Repository công khai sau chứa recipe và source archive khớp driver 7.6.7.3:
...
Các recipe/source archive liên quan là `1905daemon`, `mapd`, `wappd`, `libmapd`
và `mapfilter`. Điều này chứng minh stack cùng thế hệ driver tồn tại; nó không
tự chứng minh tương thích với kernel 6.12.

## Ràng buộc license và ABI

Nhiều file trong source archive mang thông báo MediaTek proprietary/all rights
reserved. Do đó không đưa source archive, binary, hay bản firmware chứa chúng
vào repository/release public nếu chưa có quyền phân phối phù hợp.
...
1. Chốt nguồn SDK có license phân phối và pin revision/hash.
